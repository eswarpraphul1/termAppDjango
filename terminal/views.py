	...
	if request.is_ajax():
		if request.method == 'GET':
			...
			if data['cmd'] == 'internals':
				...
				jsonResponse['internals'].append("<pre class='out-text'>	github 			- Explore the source code</pre>")
				jsonResponse['internals'].append("<pre class='out-text'>	techstack 		- tech stack for this website</pre>")
			...
			if data['cmd'] == 'about_us':
				...
				jsonResponse['about_us'].append("<pre class='out-text'>	<a href='https://www.google.com/maps/place/Jayachandran+Mahal/@12.9611977,80.185193,17z/data=!3m1!4b1!4m5!3m4!1s0x3a525e7589fb1173:0x399abec0e6e1f70a!8m2!3d12.9611977!4d80.1873817'\
			...
			if data['cmd'] == 'techstack':
				...
				jsonResponse['techstack'].append("<pre class='out-text'>	 * Jquery Terminal Emulator: <a href='http://terminal.jcubic.pl' style='color: white'>http://terminal.jcubic.pl</a></pre>")
...
def event_wed_json(request):
	...
	if request.is_ajax():
		if request.method == 'GET':
			data = request.GET.dict()
			print (data)
			if data['wedding'] == 'wedding':
				jsonResponse['wedding'] = []
				jsonResponse['wedding'].append("<b class='out-label'>wedding commands</b>")
				jsonResponse['wedding'].append("<pre class='out-text'>	wedding invite			- Print the wedding invite</pre>")
				jsonResponse['wedding'].append("<pre class='out-text'>	wedding venue			- Locate at the venue in maps</pre>")
				jsonResponse['wedding'].append("<pre class='out-text'>	wedding bride			- Know the bride</pre>")
				jsonResponse['wedding'].append("<pre class='out-text'>	wedding groom			- Know the groom</pre>")
				jsonResponse['wedding'].append("<pre class='out-text'>	wedding rsvp			- RSVP for the event</pre>")
